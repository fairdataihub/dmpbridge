...
cells = [
    ...
    md("md-1", [
        ...
        "### Micro-averaging",
        "",
        "Those formulas apply to one class. To get a single figure for the whole run, the",
        "counts are **pooled first, then divided** — every class and every document goes into",
        "one TP, one FP and one FN:",
        "",
        "```",
        ...
        "",
        "Section 2 also reports two other averages, for contrast:",
        "",
        ...
        "",
        "The three can move in different directions on the same data, so quote which one you",
        "mean. Everything in section 1 is micro.",
        "",
        "### The two paths",
        "",
    ...
    code("overall", [
        ...
        "if sup_a != sup_b:",
        "    print()",
        "    print(f'The two paths do not score the same amount of work: {sup_a} items '",
        "          f'vs {sup_b}.')",
        "    print('The revised annotation carries more questions, so comparing the two '",
        "          'f1-scores')",
        "    print('directly is comparing two different tasks. Use the per-class table '",
        "          'in section 2.')",
        "",
