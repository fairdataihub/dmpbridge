...
cells = [
    ...
    code("errors", [
        ...
        "print(f'{len(errors)} items did not match the answer key, out of',",
        "      f'{sum(len(extract_gold(resolve_new_gt_path(n), dedup_question_title=False)) for n in SAMPLES)}',",
        "      'total answer-key items across all 10 samples')",
        "print()",
