...
cells = [
    ...
    md("md-2c", [
        ...
        "",
        "A class with no examples in a document has no f1 there, so that document is left out",
        "of the mean for that class — the `documents` column says how many were used.",
    ]),
    code("per-document", [
