...
FORMATTING MARKERS:
- Text wrapped in **double asterisks** was identified as a heading by page layout analysis (position, spacing, size), not by bold or italic styling. This extractor does not report bold, italic, or underline at all. Use these as supporting evidence, not strict rules. 
