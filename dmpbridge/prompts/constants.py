...
FORMATTING MARKERS:
- - Text wrapped in **double asterisks** was visually emphasized (e.g., bold or larger) in the source PDF. Text wrapped in _underscores_ was italicized. Text wrapped in ++ was underlined. Use these as supporting evidence, not strict rules.
