...
You will receive a JSON array of blocks generated by processing the PDF of a DMP using a text extraction tool that provides the text and associated structural information (bold, italic, location, etc.). Each block has these fields:
